...
export const DashboardHeader: FC<{ size?: "sm" | "md" }> = (props) => {
  let sizeClass;
  switch (props.size) {
    case "sm":
      sizeClass = "h-8 -z-10";
  ...
  return (
    <div
      className={classNames(
        "w-full bg-gradient-to-r from-neutral-900 via-blue-800 to-blue-900 flex h-48 justify-end items-center p-2"
      )}
    >
      <Image
        width={110}
