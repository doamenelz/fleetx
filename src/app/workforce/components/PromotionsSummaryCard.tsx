...
const chartData = [
  { category: "Exec Mgmt", Years: 2 },
  { category: "Senior Mgmt", Years: 18 },
  { category: "Middle Mgmt", Years: 75 },
  { category: "Leads", Years: 29 },
  { category: "Officer", Years: 67 },
];

/** Analytics card showing the Demographics Age Distribution */
export const PromotionsSummaryCard: FC<{ config: ReportConfig }> = ({
  config,
}) => {
  return (
    <CustomCardWithTitle
